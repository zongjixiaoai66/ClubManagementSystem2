...
//            huodongShenhe.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName){
        ...
        try {
            List<HuodongShenheEntity> huodongShenheList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            HuodongShenheEntity huodongShenheEntity = new HuodongShenheEntity();
//                            huodongShenheEntity.setHuodongId(Integer.valueOf(data.get(0)));   //活动 要改的
//                            huodongShenheEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            huodongShenheEntity.setHuodongShenheYesnoTypes(Integer.valueOf(data.get(0)));   //审核状态 要改的
//                            huodongShenheEntity.setHuodongText(data.get(0));                    //审核意见 要改的
//                            huodongShenheEntity.setCreateTime(date);//时间
                            huodongShenheList.add(huodongShenheEntity);
                        ...
                        //查询是否重复
                        huodongShenheService.insertBatch(huodongShenheList);
                        return R.ok();
                    }
                }
            }
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody HuodongShenheEntity huodongShenhe, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,huodongShenhe:{}",this.getClass().getName(),huodongShenhe.toString());
        Wrapper<HuodongShenheEntity> queryWrapper = new EntityWrapper<HuodongShenheEntity>()
            .eq("huodong_id", huodongShenhe.getHuodongId())
            .eq("yonghu_id", huodongShenhe.getYonghuId())
            .eq("huodong_shenhe_yesno_types", huodongShenhe.getHuodongShenheYesnoTypes())
