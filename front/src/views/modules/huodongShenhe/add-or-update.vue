        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huodong'">
                    <el-form-item class="select" v-if="type!='info'"  label="活动信息" prop="huodongId">
                        <el-select v-model="ruleForm.huodongId" :disabled="ro.huodongId" filterable placeholder="请选择活动信息" @change="huodongChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动编号" prop="huodongUuidUnmber">
                        <el-input v-model="huodongForm.huodongUuidUnmber"
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动地点" prop="huodongAddress">
                        <el-input v-model="huodongForm.huodongAddress"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="审核意见" prop="huodongText">
                        <el-input type="textarea"  :readonly="ro.huodongText" v-model="ruleForm.huodongText" placeholder="审核意见"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.huodongText" label="审核意见" prop="huodongText">
                            <span v-html="ruleForm.huodongText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huodongId: false,
                    yonghuId: false,
                    huodongShenheYesnoTypes: false,
                    huodongText: false,
                },
                ruleForm: {
                    huodongId: '',
                    yonghuId: '',
                    huodongShenheYesnoTypes: '',
                    huodongText: '',
                },
                huodongShenheYesnoTypesOptions : [],
                huodongOptions : [],
                yonghuOptions : [],
                rules: {
                   huodongId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=huodong_shenhe_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.huodongShenheYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`huodongShenhe/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.huodongShenheCrossAddOrUpdateFlag = false;
                                        this.parent.search();
