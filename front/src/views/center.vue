  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='tuanzhang'" label='头像' prop="tuanzhangPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='tuanzhang'"  label='邮箱' prop="tuanzhangEmail">
               <el-input v-model="ruleForm.tuanzhangEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
