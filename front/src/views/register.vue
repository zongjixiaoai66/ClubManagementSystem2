    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">社团管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="团长姓名" class="input" v-if="tableName=='tuanzhang'">
                            <el-input v-model="ruleForm.tuanzhangName" autocomplete="off" placeholder="团长姓名"  />
                        </el-form-item>
                        <el-form-item label="团长手机号" class="input" v-if="tableName=='tuanzhang'">
                            <el-input v-model="ruleForm.tuanzhangPhone" autocomplete="off" placeholder="团长手机号"  />
                        </el-form-item>
                        <el-form-item label="团长身份证号" class="input" v-if="tableName=='tuanzhang'">
                            <el-input v-model="ruleForm.tuanzhangIdNumber" autocomplete="off" placeholder="团长身份证号"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='tuanzhang'">
                            <el-input v-model="ruleForm.tuanzhangEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if(this.ruleForm.repetitionPassword != this.ruleForm.password){
                             ...
                             if('tuanzhang' == this.tableName && this.ruleForm.tuanzhangPhone&&(!this.$validate.isMobile(this.ruleForm.tuanzhangPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.tuanzhangIdNumber)&& 'tuanzhang'==this.tableName){
                                this.$message.error('团长身份证号不能为空');
                                return
                            }
                            if('tuanzhang' == this.tableName && this.ruleForm.tuanzhangEmail&&(!this.$validate.isEmail(this.ruleForm.tuanzhangEmail))){
